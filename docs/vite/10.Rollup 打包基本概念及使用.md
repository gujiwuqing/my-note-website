...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/38a9405933244f0d809ff4191f5e13d4~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
通过执行`npm run build`可以发现，所有入口的不同格式产物已经成功输出: ![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/72ad6d16f5de4cca93f9cd23dffb8d3f~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
