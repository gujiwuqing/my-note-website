...
| `const foo ='foo'; let  bar='bar';  console.log(foo,bar) ` | ``   |
| ---------------------------------------------------------- | ---- |
|                                                            |      |
...
| `const say = (statements: string) => {     console.log(statements) };  // @ts-ignore say("Tecvan"); ` | ``   |
| ------------------------------------------------------------ | ---- |
|                                                              |      |

| `/******/ (() => { // webpackBootstrap var __webpack_exports__ = {}; /*!**********************!*\   !*** ./src/index.ts ***!   \**********************/ const say = statements => {   console.log(statements); }; // @ts-ignore   say("Tecvan"); /******/ })() ; ` |
| ------------------------------------------------------------ |
